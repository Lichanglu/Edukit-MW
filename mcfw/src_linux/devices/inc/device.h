...
#define ADV7442_USER_MAP_ADDR				(0x21)
#define ADV7442_USER_MAP1_ADDR				(0x23)
#define ADV7442_USER_MAP2_ADDR				(0x31)
#define ADV7442_USER_MAP3_ADDR				(0x25)
#define ADV7442_HDMI_MAP_ADDR				(0x35)
#define ADV7442_KSV_MAP_ADDR					(0x33)

#define ADV7441_I2C_INST_ID					(0x01)
#define ADV7441_USER_MAP_ADDR				(0x20)
#define ADV7441_USER_MAP1_ADDR				(0x22)
#define ADV7441_USER_MAP2_ADDR				(0x30)
...
typedef enum
{
    ...
    DEVICE_STD_VGA_640X480X60,//------17
    DEVICE_STD_VGA_640X480X72,//------18
    DEVICE_STD_VGA_640X480X75,//------19
    DEVICE_STD_VGA_640X480X85,//------20
    DEVICE_STD_VGA_800X600X60,//------21
    DEVICE_STD_VGA_800X600X72,//------22
    DEVICE_STD_VGA_800X600X75,//------23
    DEVICE_STD_VGA_800X600X85,//------24
    DEVICE_STD_VGA_1024X768X60,//------25
    DEVICE_STD_VGA_1024X768X70,//------26
    DEVICE_STD_VGA_1024X768X75,//------27
    DEVICE_STD_VGA_1024X768X85,//------28
    DEVICE_STD_VGA_1280X720X60,//------29
    DEVICE_STD_VGA_1280X768X60,//------30
    DEVICE_STD_VGA_1280X768X75,  //------31
    DEVICE_STD_VGA_1280X768X85,  //------32
    DEVICE_STD_VGA_1280X800X60,  //------33
    DEVICE_STD_VGA_1280X960X60,  //------34
    DEVICE_STD_VGA_1280X1024X60, //------35
    DEVICE_STD_VGA_1280X1024X75, //------36
    DEVICE_STD_VGA_1280X1024X85, //------37
    DEVICE_STD_VGA_1366X768X60, //------38
    DEVICE_STD_VGA_1440X900X60, //------39
    DEVICE_STD_VGA_1400X1050X60, //------40
    DEVICE_STD_VGA_1400X1050X75, //------41
    DEVICE_STD_VGA_1600X1200X60,//------42
    DEVICE_STD_VGA_1920X1080X60_DMT,//------43
