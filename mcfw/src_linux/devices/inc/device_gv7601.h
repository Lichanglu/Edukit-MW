 ...
 * \defgroup DEVICE_DRV_FVID2_DEVICE_VID_DEC_GV7601_API GV7601 Video Decoder API
 *
 *  This modules define API specific to GV7601.
 *
 * @{
*/

/**
 *  \file Device_gv7601.h
 *
 *  \brief GV7601 Video Decoder API
*/

#ifndef _DEVICE_GV7601_H_
#define _DEVICE_GV7601_H_
...
/**
  * \addtogroup DEVICE_DRV_FVID2_IOCTL_GV7601
  * @{
*/

/**
  * \brief Set GV7601 video noise filter parameters
  *
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Device_Gv7601VideoNfParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_DEVICE_GV7601_SET_VIDEO_NF      \
...
/**
  ...
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Device_Gv7601AudioModeParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_DEVICE_GV7601_SET_AUDIO_MODE    \
...
/**
 * \brief Arguments for IOCTL_DEVICE_GV7601_SET_VIDEO_NF
*/
typedef struct
{
...
} Device_Gv7601VideoNfParams;

/**
 * \brief Arguments for IOCTL_DEVICE_GV7601_SET_AUDIO_MODE
 *
...
typedef struct
{
  ...
  /**< Cascade stage number, Valid values: 0..3 */
    ...
    UInt32 audioVolume;
  /**< Audio volume, Valid values: 0..8. Refer to GV7601 datasheet for details
   */

    UInt32 tdmChannelNum;
    /**< Number of TDM channels: 0: 2CH, 1: 4CH, 2: 8CH, 3: 12CH 4: 16CH */

} Device_Gv7601AudioModeParams;
