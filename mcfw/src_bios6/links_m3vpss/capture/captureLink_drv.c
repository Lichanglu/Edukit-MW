                                          ...
                                          CaptureLink_BlindInfo *blindAreaInfo)
{
	...
	Vps_rprintf("blindAreaInfo->numBlindArea = %d\n",blindAreaInfo->numBlindArea);
                                        ...
                                        FVID2_Frame *pFrame)
{
	...
	//Vps_rprintf("pChObj->chBlindAreaConfigUpdate = %d\n",pChObj->chBlindAreaConfigUpdate);
    ...
    if(pChObj->chBlindAreaConfigUpdate == TRUE)
    {
        ...
        for(i = 0;i<blindAreaInfo->numBlindArea;i++)
        {
            if(blindAreaInfo->win[i].enableWin == TRUE)
            {
              ...
              pChObj->numBlindArea++;
              blindWin++;
			 Vps_rprintf(" CaptureLink_drvBlindAreaProcessData i=%d\n",i);
            }
        }
        pChObj->chBlindAreaConfigUpdate = FALSE;
    }
