...
//	staticParams->intraCodingParams.intraCodingPreset =IH264_INTERCODING_USERDEFINED;
...
#endif
	staticParams->framePackingSEIParams.framePackingPreset=0;
	staticParams->enableGMVSei=0;
...
#if 0
/*MED_SPEED_HIGH_QUALITY*/
static Int mshq_enclink_h264_set_dynamic_params(IH264ENC_DynamicParams *
                                           dynamicParams,
                                           EncLink_AlgDynamicParams *
                                           algDynamicParams)
{
    *dynamicParams = H264ENC_TI_DYNAMICPARAMS;
    ...
    dynamicParams->videnc2DynamicParams.inputHeight = algDynamicParams->inputHeight;
    dynamicParams->videnc2DynamicParams.refFrameRate =algDynamicParams->refFrameRate;
    dynamicParams->videnc2DynamicParams.targetFrameRate =algDynamicParams->targetFrameRate;
    dynamicParams->videnc2DynamicParams.targetBitRate =algDynamicParams->targetBitRate;
    dynamicParams->videnc2DynamicParams.intraFrameInterval =algDynamicParams->intraFrameInterval;
	dynamicParams->videnc2DynamicParams.generateHeader = 0;
    dynamicParams->videnc2DynamicParams.captureWidth =algDynamicParams->inputPitch;
    dynamicParams->videnc2DynamicParams.forceFrame = -1;	
    dynamicParams->videnc2DynamicParams.interFrameInterval =algDynamicParams->interFrameInterval;
    dynamicParams->videnc2DynamicParams.mvAccuracy =algDynamicParams->mvAccuracy;
    ...
    dynamicParams->videnc2DynamicParams.getBufferFxn =enclink_h264_dummy_get_buffer_fxn;


    dynamicParams->rateControlParams.rateControlParamsPreset = IH264_RATECONTROLPARAMS_DEFAULT;
	//dynamicParams->rateControlParams.rateControlParamsPreset == IH264_RATECONTROLPARAMS_DEFAULT;
	dynamicParams->rateControlParams.scalingMatrixPreset = 0;
    dynamicParams->rateControlParams.rcAlgo = IH264_RATECONTROL_PRC;//IH264_RATECONTROL_PRC_LOW_DELAY;
    dynamicParams->rateControlParams.qpI    = -1;	
    dynamicParams->rateControlParams.qpMaxI = 36;
    dynamicParams->rateControlParams.qpMinI = 10;
    dynamicParams->rateControlParams.qpP    = -1;
    dynamicParams->rateControlParams.qpMaxP = 40;
    dynamicParams->rateControlParams.qpMinP = 10;
    dynamicParams->rateControlParams.qpOffsetB = 4;
    dynamicParams->rateControlParams.qpMaxB = 44;
    dynamicParams->rateControlParams.qpMinB = 10;

    dynamicParams->rateControlParams.allowFrameSkip = 0;
    dynamicParams->rateControlParams.removeExpensiveCoeff = 0;	
    dynamicParams->rateControlParams.chromaQPIndexOffset = 0;	
    dynamicParams->rateControlParams.IPQualityFactor = 0;	
	...
	Vps_printf("HRDBufferSize=%d,target=%d,init=%d\n",
		dynamicParams->rateControlParams.HRDBufferSize,algDynamicParams->targetBitRate, dynamicParams->rateControlParams.initialBufferLevel);
	
    dynamicParams->rateControlParams.minPicSizeRatioI = 0;	
    dynamicParams->rateControlParams.maxPicSizeRatioI = 0;	
    dynamicParams->rateControlParams.minPicSizeRatioP = 0;
	dynamicParams->rateControlParams.maxPicSizeRatioP = 0;
    dynamicParams->rateControlParams.minPicSizeRatioB = 0;
	dynamicParams->rateControlParams.maxPicSizeRatioB = 0;

	dynamicParams->rateControlParams.enablePRC = 1;
	dynamicParams->rateControlParams.enablePartialFrameSkip = 0;
	dynamicParams->rateControlParams.discardSavedBits = 0;
	
    dynamicParams->rateControlParams.VBRDuration = 8;
    dynamicParams->rateControlParams.VBRsensitivity =0;
    ...
    dynamicParams->rateControlParams.enableHRDComplianceMode=1;
    dynamicParams->rateControlParams.frameSkipThMulQ5 = 0;
    dynamicParams->rateControlParams.vbvUseLevelThQ5 = 0;


	//add by zm 开启p帧的8*8
	dynamicParams->interCodingParams.interCodingPreset =IH264_INTERCODING_DEFAULT;//IH264_INTERCODING_MED_SPEED_HIGH_QUALITY;
	dynamicParams->interCodingParams.searchRangeHorP = 144;
	dynamicParams->interCodingParams.searchRangeVerP = 32;
	dynamicParams->interCodingParams.searchRangeHorB = 144;
	dynamicParams->interCodingParams.searchRangeVerB = 16;
	dynamicParams->interCodingParams.interCodingBias = 1;
	dynamicParams->interCodingParams.skipMVCodingBias = 1;
	dynamicParams->interCodingParams.minBlockSizeP = IH264_BLOCKSIZE_8x8;
	dynamicParams->interCodingParams.minBlockSizeB = IH264_BLOCKSIZE_8x8;
	dynamicParams->interCodingParams.meAlgoMode = 0;

	

	dynamicParams->intraCodingParams.intraCodingPreset		= IH264_INTRACODING_DEFAULT;
	dynamicParams->intraCodingParams.lumaIntra4x4Enable		  = 0x0;
	dynamicParams->intraCodingParams.lumaIntra8x8Enable		  = 0x0FF;
	dynamicParams->intraCodingParams.lumaIntra16x16Enable   = 0xF;
	dynamicParams->intraCodingParams.chromaIntra8x8Enable   = 0xF;
	dynamicParams->intraCodingParams.chromaComponentEnable	  = 0;
	dynamicParams->intraCodingParams.intraRefreshMethod		  = 0;
	...
	dynamicParams->sliceCodingParams.sliceMode          = IH264_SLICEMODE_DEFAULT;
	dynamicParams->sliceCodingParams.sliceUnitSize      = 416;
//	dynamicParams->sliceCodingParams -> sliceStartOffset   = [2 0 2];
	dynamicParams->sliceCodingParams.streamFormat       = 0;

	dynamicParams->sliceGroupChangeCycle= 3072;
//	dynamicParams->searchCenter                    = 0;
	dynamicParams->enableStaticMBCount             = 0;
	dynamicParams->intraRefreshRateGDRDynamic      =262400;
	dynamicParams->gdrOverlapRowsBtwFramesDynamic  = 0;
                                           ...
                                           algDynamicParams)
{
...
#if 0
	return mshq_enclink_h264_set_dynamic_params(dynamicParams,algDynamicParams);
#endif
    ...
    *dynamicParams = H264ENC_TI_DYNAMICPARAMS;
	...
	dynamicParams->rateControlParams.scalingMatrixPreset = 0;
    dynamicParams->rateControlParams.rcAlgo =IH264_RATECONTROL_PRC;// algDynamicParams->rcAlg;  //IH264_RATECONTROL_PRC_LOW_DELAY;
    dynamicParams->rateControlParams.qpI    = algDynamicParams->qpInitI;	
    dynamicParams->rateControlParams.qpMaxI = algDynamicParams->qpMaxI;
    dynamicParams->rateControlParams.qpMinI = algDynamicParams->qpMinI;
    dynamicParams->rateControlParams.qpP    = algDynamicParams->qpInitP;
	...
	//add by zm 开启p帧的8*8
//	dynamicParams->interCodingParams.interCodingPreset =IH264_INTERCODING_USERDEFINED;//IH264_INTERCODING_MED_SPEED_HIGH_QUALITY;
//	dynamicParams->interCodingParams.minBlockSizeP = IH264_BLOCKSIZE_8x8;
//	dynamicParams->interCodingParams.minBlockSizeB = IH264_BLOCKSIZE_8x8;
