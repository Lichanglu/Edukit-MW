                                      ...
                                      UInt32 * pWidth, UInt32 * pHeight)
{
	...
	Vps_printf("resClass == %d ,*pWidth=%d,*pHeight =%d\n",resClass,*pHeight,*pHeight);
	return status;
}
        ...
        EncLink_ReqObj * reqObj, UInt32 chId)
{
	...
	{
	/*
		pFrameInfo->rtChInfo.height   = VpsUtils_align(pFrameInfo->rtChInfo.height,   8);
		pFrameInfo->rtChInfo.width    = VpsUtils_align(pFrameInfo->rtChInfo.width,   16);
		pFrameInfo->rtChInfo.pitch[0] = VpsUtils_align(pFrameInfo->rtChInfo.pitch[0],16);
*/
